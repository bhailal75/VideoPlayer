package com.xodec.videoplayer.helper;
...
//import com.example.bhoomi.lms.APIModel.Subscribe.SubscrbeResp;
...
//
    @GET(Config.GET_VIDEO)
    Call<Example> getAllVideoItem();
//
//    @POST(Config.MENU_ITEM_URL)
//    Call<MenuItemResp> AddMenuItem(@Header("Authorization") String authorization, @Body Map<String, String> body);
//
